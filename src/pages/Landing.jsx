    ...
    <Box sx={{ flexGrow: 1, minHeight: '100vh', display: 'flex', flexDirection: 'column', bgcolor: '#f8fafc' }}>
      ...
      <Box sx={{ py: 10, textAlign: 'center', px: 2 }}>
        <Container maxWidth="md">
          <Typography variant="h2" component="h1" gutterBottom fontWeight="800" sx={{ fontSize: { xs: '2.5rem', md: '3.75rem' } }}>
          ...
          <Typography variant="h6" color="text.secondary" paragraph sx={{ mb: 4, fontWeight: 400 }}>
            Єдина безпечна веб-платформа для зберігання результатів аналізів, 
            рецептів та історій хвороб. Прозорий доступ для вас та вашого лікаря.
          </Typography>
          <Button 
            variant="contained" 
            size="large" 
    ...
    {/* Блок переваг (Features) */}
      <Container maxWidth="lg" sx={{ mb: 10, flexGrow: 1 }}>
        <Box sx={{ 
          ...
          <Card sx={{ height: '100%', textAlign: 'center', p: 3, borderRadius: 3, boxShadow: '0 4px 20px rgba(0,0,0,0.05)' }}>
            ...
            <CardContent sx={{ p: 0 }}>
              ...
              <Typography color="text.secondary">
                Завантажуйте медичні записи, PDF-документи, знімки та результати аналізів у своєму профілі.
              </Typography>
            </CardContent>
          </Card>
          ...
          <Card sx={{ height: '100%', textAlign: 'center', p: 3, borderRadius: 3, boxShadow: '0 4px 20px rgba(0,0,0,0.05)' }}>
            ...
            <CardContent sx={{ p: 0 }}>
              ...
              <Typography color="text.secondary">
                Зручний перегляд усіх медичних записів, діагнозів та планів лікування в єдиному кабінеті.
              </Typography>
            </CardContent>
          </Card>
          ...
          <Card sx={{ height: '100%', textAlign: 'center', p: 3, borderRadius: 3, boxShadow: '0 4px 20px rgba(0,0,0,0.05)' }}>
            ...
            <CardContent sx={{ p: 0 }}>
              ...
              <Typography color="text.secondary">
                Повний контроль безпеки даних: дивіться прозорий лог, хто і коли переглядав вашу медичну картку.
              </Typography>
            </CardContent>
          </Card>
      ...
      {/* Простий футер */}
      <Box sx={{ bgcolor: 'white', py: 3, textAlign: 'center', borderTop: '1px solid #e0e0e0' }}>
